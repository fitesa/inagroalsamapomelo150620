...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.193929 && value <= -0.106391) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.106391 && value <= -0.018853) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.018853 && value <= 0.068686) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.068686 && value <= 0.156224) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.156224 && value <= 0.243762) {
            style = [ new ol.style.Style({
