...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.113321 && value <= 0.220049) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.220049 && value <= 0.326778) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.326778 && value <= 0.433506) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.433506 && value <= 0.540235) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.540235 && value <= 0.646963) {
            style = [ new ol.style.Style({
